            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Palpa Asintomaricon</span>
                </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="../certificados/index.php">
                <i class="fa fa-graduation-cap"></i>
                <span>Certificados</span>
              </a>
            </li> 

             <!-- En la parte de abajo esta el anterior -->
           ...
           <!--  <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="articulo.php"><i class="fa fa-circle-o"></i> Cursos</a></li>
                <li><a href="categoria.php"><i class="fa fa-circle-o"></i> Registrar Asistencia</a></li>
              </ul>
            </li>
